...
<body>
    ...
    <div class="site-wrap" id="home-section">
        ...
        <div class="hero" style="background-image: url('assets/web/images/hero_1_a.jpg');">
                    ...
                    <div class="col-lg-10">
                        ...
                        <div class="row mb-5">
                            <div class="col-lg-7 intro">
                                <h1><strong>Sewa Mobil</strong> Lepas Kunci</h1>
                            </div>
                        </div>
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-7 mb-4 mb-md-0">
                        <h2 class="mb-0 text-white">Apa yang kamu tunggu?</h2>
                        <p class="mb-0 opa-7">Hubungi Kami sekarang juga</p>
                    </div>
