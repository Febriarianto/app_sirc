                    ...
                    <div class="col-md-6 col-lg-4 mb-4">
                        ...
                        <div class="listing d-block  align-items-stretch">
                            ...
                            <div class="listing-contents h-100">
                                ...
                                <div>
                                    <h3><span class="badge {{$k->s != null ? 'badge-danger' : 'badge-success'}} float-right">{{$k->s != null ? 'Sedang Disewa' : 'Tersedia'}}</span></h3>
                                    <a href="{{$k->id_kendaraan != null ? '' : 'https://api.whatsapp.com/send/?phone='.SettingWeb::get_setting()->telp.'&text=Hai%27Admin+Saya+ingin%27Menyewa+Mobil+'.$k->nama.'+warna%27'.$k->warna.'&type=phone_number&app_absent=0'}}" class="btn btn-success btn-sm {{$k->id_kendaraan != null ? 'disabled' : ''}}"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-whatsapp" viewBox="0 0 16 16">
                    ...
                    <div class="col-md-12">
                        <div class="border-top pt-5">
                            <p>
                                ...
                                </script> <i class="icon-heart text-danger" aria-hidden="true"></i> by ConceptAutoRent <a href="" target="_blank"></a>
                            </p>
                        </div>
                    </div>
