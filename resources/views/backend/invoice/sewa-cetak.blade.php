...
<body>
    ...
    <table border="0" style="height: 907.08661417px; width: 1058.2677165px; padding: 0; margin: 0;">
        <tr>
            ...
            <td style="text-align: center;">
                ...
                <div style="margin-left: 20px; margin-right: 20px; margin-bottom: 20px;">
                    ...
                    <div style="border: solid black 1px;"> {{ $transaksi->id }}</div>
                </div>
                <div style="background-color: black; color: white; padding: 3px; margin-bottom: 2px; border-radius: 5px 5px 5px 5px;">
                    Rincian Biaya</div>
            </td>
        ...
        <tr>
            ...
            <td>DP</td>
            <td style="border-bottom: solid black 2px;">: {{ $transaksi->dp }}</td>
        </tr>
        <tr>
            <td>Tujuan Kota</td>
        ...
        <tr>
            <td>Kendaraan</td>
            <td>: {{ $transaksi->kendaraan->jenis->nama }} No.Pol : {{ $transaksi->kendaraan->no_kendaraan }}</td>
        </tr>
        <tr>
            <td>Lama Sewa</td>
        ...
        <tr>
            ...
            <td>: {{ strftime('%d %B %Y', strtotime($transaksi->keberangkatan)) }} / Jam :{{ date('H:i:s', strtotime($transaksi->keberangkatan)) }}</td>
            <td>Dongkrak</td>
            <td>: .....................................................</td>
        </tr>
        <tr>
            <td>Hari/Tanggal Pulang </td>
            <td>: {{ strftime('%d %B %Y', strtotime($transaksi->kepulangan)) }} / Jam :{{ date('H:i:s', strtotime($transaksi->kepulangan)) }}</td>
            <td>Ban Cadangan</td>
            <td>: .....................................................</td>
        </tr>
        <tr>
            <td>Over Time</td>
            <td>: {{ $transaksi->biaya_overtime }}</td>
            <td>Kelengkapan</td>
            <td>: </td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="2" style="text-align: center;">
                Pringsewu , {{ strftime('%d %B %Y', strtotime($transaksi->keberangkatan)) }}
            </td>
        </tr>
        <tr>
