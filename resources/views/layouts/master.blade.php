...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">{{ $config['title'] }}</a></li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
        ...
        <footer class="main-footer">
            <strong>Copyright &copy; <a href="https://conceptautorent.com" target="_blank">Concept Autorent</a>.</strong>
    ...
    @include('layouts.script.default')
    @yield('script')
</body>
